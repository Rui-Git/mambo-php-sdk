...
class UserRequestData extends AbstractHasTagRequestData
{
	...
	public function setDetails( Nested\UserDetails $userDetails ) { $this->data['details'] = $userDetails; }
	...
	public function setFacebook( Nested\FacebookDetails $facebookDetails ) { $this->data['facebook'] = $facebookDetails; }
	...
	public function setTwitter( Nested\TwitterDetails $twitterDetails ) { $this->data['twitter'] = $twitterDetails; }
