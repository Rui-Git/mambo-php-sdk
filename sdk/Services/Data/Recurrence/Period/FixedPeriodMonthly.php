 ...
 */
/**
 * Represents an object which recurs on a fixed monthly interval.
 * For example:
...
class FixedPeriodMonthly
{
	...
	/**
	 * The month interval indicates every how many months the object should recur.
	 * Valid values range from 1 to 12.
	 * This field cannot be null.
	 * @return
	 */
	public function getMonthInterval() { return $this->data['monthInterval']; }
	public function setMonthInterval( $monthInterval ) { $this->data['monthInterval'] = $monthInterval; }
