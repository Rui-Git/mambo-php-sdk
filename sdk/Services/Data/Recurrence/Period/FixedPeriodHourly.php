...
class FixedPeriodHourly
{
	 ...
	 * @return
	 */
	public function getHourInterval() { return $this->data['hourInterval']; }
	public function setHourInterval( $hourInterval ) { $this->data['hourInterval'] = $hourInterval; }
