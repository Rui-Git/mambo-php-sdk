...
class PurchaseRequestData
{
	...
	public function setMonetaryValues( Nested\MonetaryValues $monetaryValues ) { $this->data['monetaryValues'] = $monetaryValues; }
	...
	public function addProduct( Nested\Product $product ) {
