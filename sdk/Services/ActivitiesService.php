...
class MamboActivitiesService extends MamboBaseAbstract
{
	...
	public static function create( $siteUrl, $data )
	{
		...
		if( !( $data instanceof Data\ActivityRequestData ) )
		{
	...
	public static function reject( $id, $data )
	{
		...
		// Check the request data is valid
		if( !( $data instanceof Data\RejectActivityRequestData ) )
		{
	 ...
	 * @return
	 */
	public static function getActivities( $siteUrl, $tags = null, $tagsJoin = null, $tagUuid = null, $page = null,
							$count = null, $withRewardsOnly = null, $withInternalPoints = null,
							$rewardIds = null, $behaviourIds = null, $withExceptions = null,
							$pointIds = null, $withBehavioursOnly = null, $withMissionsOnly = null,
							$withLevelsOnly = null, $withAchievementsOnly = null, $withGiftsOnly = null )
	{
		// Initialise the client if necessary
		self::initClient();
	 ...
	 * @return
	 */
	public static function getActivitiesByUser( $siteUrl, $uuid, $tags = null, $tagsJoin = null, $tagUuid = null, $page = null,
											$count = null, $withRewardsOnly = null, $withInternalPoints = null,
