...
class MamboPointsService extends MamboBaseAbstract
{
	...
	public static function create( $siteUrl, $data )
	{
		...
		if( !( $data instanceof Data\PointRequestData ) )
		{
	 ...
	 * @return
	 */
	public static function clonePoint( $id )
	{
		// Initialise the client if necessary
		self::initClient();

		// Make the request
		return self::$client->request( self::getWithId( self::POINTS_CLONE_URI, $id ), MamboClient::POST );
	}
	 ...
	 * @return
	 */
	public static function getPoints( $siteUrl, $tags = null, $tagsJoin = null, $tagUuid = null )
	{
		// Initialise the client if necessary
		self::initClient();
	 ...
	 * @return
	 */
	public static function getExternalPoints( $siteUrl, $tags = null, $tagsJoin = null, $tagUuid = null )
	{
		// Initialise the client if necessary
		self::initClient();
	 ...
	 * @return
	 */
	public static function getInternalPoints( $siteUrl, $tags = null, $tagsJoin = null, $tagUuid = null )
	{
		// Initialise the client if necessary
		self::initClient();
